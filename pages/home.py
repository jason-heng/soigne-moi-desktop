...
class HomePage(CTkFrame):
    def __init__(self, window: CTk, token : str, secretary: Secretary, past_page: CTkFrame = None) -> None:
        ...
        super().__init__(window, corner_radius=0, fg_color=Colors.TERTIARY_LIGHT)
    ...
    def view(self):
        ...
        page_content = CTkFrame(self, fg_color=Colors.TERTIARY_LIGHT, width=770, corner_radius=0)
